...
yt_dlp_name="yt-dlp-2026.08.19-linux"
yt_dlp_url="https://github.com/yt-dlp/yt-dlp/releases/download/2026.08.19/yt-dlp"
...
yt_dlp_licenses="$cache_root/YTDLP-2026.08.19-LICENSES.txt"
download_verified \
...
install -m 0644 "$yt_dlp_licenses" "$staged_distribution/tools/YTDLP_LICENSES.txt"
